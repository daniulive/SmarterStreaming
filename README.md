...
跨平台rtmp推流、rtmp／rtsp直播播放利器"SmarterStreaming"，系daniulive（大牛直播）出品的跨平台视频采集、直播SDK（支持rtmp推流/rtmp播放/rtsp播放，如windows推流/android推流/iOS推流/windows播放器/android播放器/iOS播放器），公网毫秒级延迟，也许是国内最靠谱的视频直播推流、播放SDK之一，助您轻松实现类似于花椒、映客、斗鱼手机直播推送与播放。
...
4. **android播放器/iOS播放器**
 ...
 i)支持软硬解码，业内真正靠谱的超低延迟、低资源占用播放rtsp/rtmp 1080p+。
