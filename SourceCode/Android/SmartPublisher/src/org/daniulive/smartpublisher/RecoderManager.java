...
import org.daniulive.smartpublisher.CameraPublishActivity.ButtonRecoderMangerListener;
...
public class RecoderManager extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_recoder_manager);
	...
	private void PlayRecFile(String fileName)
	{
		...
		if ( filePath != null && !filePath.isEmpty() )
		{
			Log.i(Tag, "PlayRecFile name:" + fileName + " path:" + filePath);
             ...
             intent.setClass(RecoderManager.this, RecoderPlaybak.class);
             intent.putExtra("RecoderFilePath", filePath);
