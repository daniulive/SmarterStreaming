...
- (void)loadView
{
    ...
    [self.navigationItem setTitle:@"大牛直播推流端V1.0.06.06.23"];
    ...
    self.interPublisherView.frame = CGRectMake(kHorMargin, kVerMargin+kBtnHeight+80+80+60, buttonWidth, kBtnHeight);
    ...
    self.interRecorderView.frame = CGRectMake(kHorMargin, kVerMargin+kBtnHeight+80+80+80+60, buttonWidth, kBtnHeight);
...
- (void)interPublisherViewBtnPressed:(id)sender {
    ViewController * coreView =[[ViewController alloc] initParameter:streamQuality isAudioOnly:is_audio_only_ isRecorder:is_recorder_];
