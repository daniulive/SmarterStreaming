...
public class SmartPlayer extends AppCompatActivity implements android.view.SurfaceHolder.Callback {
    ...
    private void PopInputKeyDialog() {
        ...
        inputKeyTxt.setHint("请输入RTMP解密Key");
        inputKeyTxt.setText("");

        final EditText inputIVTxt = new EditText(this);
        inputIVTxt.setFocusable(true);
        inputIVTxt.setHint("请输入RTMP IV解密向量(如推送端未设置，无需输入)");
        inputIVTxt.setText("");

        AlertDialog.Builder builderKey = new AlertDialog.Builder(this);
        builderKey.setTitle("如加密流，请输入解密Key(16/24/32字节)和IV解密向量(16字节)");
    ...
    private void inflateLayout(int orientation) {
        ...
        txtEventMsg.setTextColor(0xffff0000);
        txtEventMsg.setLayoutParams(new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        txtEventMsg
                .setText("Copyright 2014~2019 www.daniulive.com v1.0.18.0622");
        ...
        btnPopInputUrl.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        lLinearLayout.addView(btnPopInputUrl);

        btnPopInputKey = new Button(this);
        btnPopInputKey.setText("输入解密Key");
        btnPopInputKey.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        lLinearLayout.addView(btnPopInputKey);
        ...
        btnMute.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
        ...
        btnSwitchUrl.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnFlipVertical.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnFlipHorizontal.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        LinearLayoutImage.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnCaptureImage.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnRotation.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnSetPlayBuffer.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnStartStopRecorder.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        recorderLinearLayout.addView(btnStartStopRecorder);

        btnRecoderMgr = new Button(this);
        btnRecoderMgr.setText("录像管理 ");
        btnRecoderMgr.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        btnPopInputKey.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                PopInputKeyDialog();
            }
        });
